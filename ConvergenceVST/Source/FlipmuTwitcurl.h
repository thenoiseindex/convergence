/*
  ==============================================================================
    ...
    FlipmuTwitcurl.h
    Created: 5 May 2014 11:24:11pm
    Author:  Owen Vallis

  ==============================================================================
*/

#ifndef FLIPMUTWITCURL_H_INCLUDED
#define FLIPMUTWITCURL_H_INCLUDED


#include "twitcurl.h"

class FlipmuTwitcurl{
...
public:
    ...
    void getTrend(std::string WOEID){
...
#endif  // FLIPMUTWITCURL_H_INCLUDED
