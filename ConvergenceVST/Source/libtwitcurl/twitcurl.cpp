...
/*++
 * @method: twitCurl::trendsPlaceGet()
 *
 * @description: gets available trends.
 *
 * @input: none
 ...
 *
 *--*/
bool twitCurl::trendsPlaceGet(std::string WOEID)
{
    /* Perform GET */
    return performGet( twitCurlDefaults::TWITCURL_PROTOCOLS[m_eProtocolType] +
                      twitterDefaults::TWITCURL_PLACE_URL +
                      twitCurlDefaults::TWITCURL_EXTENSIONFORMATS[m_eApiFormatType] +
                      twitCurlDefaults::TWITCURL_URL_SEP_QUES + twitCurlDefaults::TWITCURL_WOEID_REQUEST + WOEID);
}
